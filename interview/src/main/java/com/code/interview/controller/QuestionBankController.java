...
import com.code.interview.model.dto.questionBank.QuestionBankAddRequest;
import com.code.interview.model.dto.questionBank.QuestionBankEditRequest;
import com.code.interview.model.dto.questionBank.QuestionBankQueryRequest;
import com.code.interview.model.dto.questionBank.QuestionBankUpdateRequest;
...
import com.code.interview.model.enums.QuestionBankPriorityEnum;
import com.code.interview.model.vo.QuestionBankVO;
...
public class QuestionBankController {
    ...
    public BaseResponse<Long> addQuestionBank(@RequestBody QuestionBankAddRequest questionBankAddRequest, HttpServletRequest request) {
        ...
        questionBank.setPriority(QuestionBankPriorityEnum.getValue(QuestionBankPriorityEnum.NORMAL));
        // 写入数据库
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        if (needQueryQuestionList) {
            ...
            questionQueryRequest.setPageNum(questionBankQueryRequest.getPageNum());
    ...
    public BaseResponse<Page<QuestionBank>> listQuestionBankByPage(@RequestBody QuestionBankQueryRequest questionBankQueryRequest) {
        long current = questionBankQueryRequest.getPageNum();
